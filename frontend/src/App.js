      ...
      <div className="App">
        <Routes>
          ...
          <Route element={<Layout />}>
            ...
            <Route
              path="/admin/profitovertime"
              element={<Components.ProfitOverTime />}
            />
            <Route
              path="/admin/profitbyproduct"
              element={<Components.ProfitByProduct />}
            />
            ...
            <Route
              path="/admin/themphieunhap"
              element={<Components.ImportCoupon />}
            />
            <Route
              path="/admin/phieunhap"
              element={<Components.ShowCoupon />}
            />
            <Route
              path="/admin/phieunhap-detail/:id"
              element={<Components.DetailCoupon />}
            />
            <Route
              path="/admin/export/:id"
              element={<Components.ExportPDF />}
            />
          </Route>
          {/* shipper*/}
          ...
          <Route element={<LayoutShipper />}>
            <Route
              path="/shipper/status/success"
              element={<Components.Success />}
            />
            ...
            <Route
              path="/shipper/orderdestroy"
              element={<Components.OrderDestroy />}
            />
          </Route>
          <Route element={<LayoutCustomer />}>
            ...
            <Route
              ...
              element={<Components.ForgotPasswordCustomer />}
            />
            <Route
              path=":token/reset-password"
              element={<Components.ResetPasswordCustomer />}
            />
