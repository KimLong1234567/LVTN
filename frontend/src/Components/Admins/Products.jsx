    ...
    <div className="boder-main">
      ...
      <div className="d-flex justify-content-between mt-2 px-4 pb-2">
        ...
        <Button variant="success" onClick={() => setShow(true)}>
          add new product <Icon icon={faSquarePlus} />
        </Button>
        <Modal show={show !== false} onHide={() => setShow(false)}>
          <Modal.Header closeButton>
            <Modal.Title>
              {' '}
              {selected.sp_id ? 'Update product' : 'Add new product'}
            </Modal.Title>
          </Modal.Header>
          <Modal.Body>
            <Form>
                ...
                <Col xs={6}>
                  ...
                  >
                    ...
                    <Form.Control
                      type="text"
                      placeholder={
                        selected.sp_code ? selected.sp_code : 'product code '
                      }
                      name="sp_code"
                      onChange={onChange}
                    />
                ...
                <Col xs={6}>
                  ...
                  >
                    ...
                    <Form.Control
                      type="text"
                      placeholder={
                        selected.sp_name ? selected.sp_name : 'product name'
                      }
                      name="sp_name"
                      onChange={onChange}
                    />
                ...
                <Col xs={6}>
                  ...
                  >
                    ...
                    >
                      ...
                      {Type.map((type, idx) => (
                        <option name="cate_id" value={type.cate_id} key={idx}>
                          {type.cate_name}
                        </option>
                      ))}
                    </Form.Select>
                ...
                <Col xs={6}>
                  ...
                  >
                    ...
                    <Form.Control
                      type="text"
                      placeholder={
                        selected.sp_xuatxu ? selected.sp_xuatxu : 'origin'
                      }
                      name="sp_xuatxu"
                      onChange={onChange}
                    />
                ...
                <Col xs={6}>
                  ...
                  >
                    ...
                    <Form.Control
                      type="number"
                      placeholder={
                        selected.sp_price ? selected.sp_price : 'price'
                      }
                      name="sp_price"
                      onChange={onChange}
                    />
          ...
          <Modal.Footer>
            {selected.sp_id !== undefined ? (
              <Button
                variant="primary"
                onClick={() => editProducts(selected.sp_id)}
              >
                UPDATE
              </Button>
            ) : (
              ...
              <tr key={idx}>
                ...
                <td>
                  <Form.Check
                    ...
                    id="custom-switch"
                    onChange={() => {
                      statusProducts(product.sp_id, product.s_status);
                    }}
                    checked={product.s_status === 1 ? true : false}
                  />
                </td>
                ...
                <td className="text-center">
                  <button
                    ...
                    onClick={() => deleteProducts(product.sp_id)}
                  >
