...
function Header(props) {
  ...
  return (
    <div>
      <Navbar
        style={{ background: 'rgb(231,221,255)' }}
        variant="dark"
      ...
      >
        <Dropdown>
          ...
          >
            ...
            <img
              src={'/image/Avt/' + curentAdmin.nv_avt}
              alt="..."
              className="mx-1"
            ></img>
          </Dropdown.Toggle>
          <Dropdown.Menu>
            <Dropdown.Item>
              <Link to={'/admin/myinfo'} className="text-danger">
                Info <Icon icon={faCircleInfo} />
              </Link>
            </Dropdown.Item>
            <Dropdown.Item>
              <Link onClick={() => logout()} className="text-danger">
                Logout <Icon icon={faRightFromBracket} />
              </Link>
            </Dropdown.Item>
