...
function Myinfo(props) {
  ...
  return (
    <div className="boder-main">
      <ToastContainer />
      <h3 className="fw-bold text-uppercase mt-3 text-danger">
        {' '}
          ...
          <Form>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control
                type="text"
                name="nv_adress"
                placeholder={Accounts.nv_adress}
                onChange={onChange}
              />
            </Form.Group>
            <Form.Group className="mb-3">
