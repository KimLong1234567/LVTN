...
function Feedbacks(props) {
  ...
  function addFeedback(id) {
    axios.put(`http://localhost:5000/api/contacts/${id}`, reply).then((res) => {
    ...
    <div className="boder-main">
      ...
      >
        ...
        <Modal.Footer>
          <Button
            variant="success"
            onClick={() => addFeedback(showModal.lh_id)}
          >
            feedback
          </Button>
        </Modal.Footer>
      ...
      <table className="table table-bordered">
        ...
        {feedback !== undefined && feedback.length !== 0 ? (
              ...
              <tbody key={i}>
                <tr>
                  ...
                  {item.lh_img ? (
                    <td>
                      <img
                        src={`/image/contacts/${item.lh_img}`}
                        alt="..."
                        style={{ width: '150px' }}
                      />
                    </td>
          ...
          <tbody>
            <tr>
              <td className="text-danger text-uppercase h3" colSpan={9}>
