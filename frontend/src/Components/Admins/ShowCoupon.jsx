...
function ShowCoupon(props) {
  ...
  useEffect(() => {
    axios.get('http://localhost:5000/api/pn/ctpn').then((res) => {
  ...
  return (
    <div className="boder-main">
      <div>
        ...
        <table
          className="table-export table table-bordered align-middle r"
          id="export-table"
        >
          ...
          {showAllCoupon !== undefined && showAllCoupon.length !== 0 ? (
            ...
            <tbody>
              <tr>
                <td colSpan={5} className="h3 text-center text-danger ">
