  ...
  return (
    <div className="boder-main">
      ...
      <div className="d-flex justify-content-between m-3">
        <h4 className="text-primary fw-bold text-uppercase">
        ...
        <Button variant="success" onClick={() => setShow(true)}>
          Add new account <Icon icon={faSquarePlus} />
        </Button>
        <Modal show={show !== false} onHide={() => setShow(false)}>
            ...
            <Form>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="text"
                  name="user_name"
                  placeholder={show.user_name ? show.user_name : 'Name'}
                  onChange={onChange}
                />
              </Form.Group>
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="text"
                  name="user_email"
                  placeholder={show.user_email ? show.user_email : 'Email'}
                  onChange={onChange}
                />
              </Form.Group>
              <Form.Group className="mb-3">
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  type="text"
                  name="user_phone"
                  placeholder={show.user_phone ? show.user_phone : 'Phone'}
                  onChange={onChange}
                />
              </Form.Group>
              <Form.Group className="mb-3">
              ...
              <Form.Group className="mb-3">
                ...
                <Form.Control
                  ...
                  name="user_address"
                  placeholder={
                    show.user_address ? show.user_address : 'Address'
                  }
                  onChange={onChange}
                />
              </Form.Group>
          ...
          <Modal.Footer>
            {show.user_id !== undefined ? (
              <Button
                variant="primary"
                onClick={() => updateAccount(show.user_id)}
              >
                Update
              </Button>
            ) : (
          ...
          <tbody>
            {Accounts.map((account, i) => (
              <tr key={i}>
                ...
                <td>
                  <img
                    src={`/image/avt/${account.user_avt}`}
                    className="mb-2 mt-2"
                    style={{ width: '150px' }}
                    alt="..."
                  />
