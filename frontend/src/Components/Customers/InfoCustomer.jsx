...
function InfoCustomer(props) {
  ...
  useLayoutEffect(() => {
    async function fetchData() {
      ...
      const res = await axios.get(
        `http://localhost:5000/api/users/user/${curentAccount.user_id}`
      );
      // console.log(res);
  ...
  function update(id) {
    ...
    axios
      .put(`http://localhost:5000/api/users/${id}`, formdata, {
                ...
                <Form>
                  ...
                  <Form.Group className="mb-3">
                    ...
                    {user[0].user_address ? (
                      <Form.Control
                        type="text"
                        placeholder={user[0].user_address}
                        name="user_address"
                        onChange={onchange}
                      />
                    ) : (
            ...
            <Col xs={12} md={6}>
              {user[0] !== undefined ? (
                <div className="text-start ps-5 m-3">
                  <h5>
                    Your name:{' '}
                    <span className="text-danger">{user[0].user_name}</span>
                  </h5>
                  <h5>
                    Your Account:{' '}
                    <span className="text-danger">{user[0].user_email}</span>
                  </h5>
                  <h5>
                    Your Phone:
                    <span className="text-danger">
                      ...
                      {user[0].user_phone ? (
                        ...
                        <span className="text-danger"> No information </span>
                      )}
                    </span>
                  </h5>
                  <h5>
