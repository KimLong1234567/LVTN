...
function BookPet(props) {
  ...
  useEffect(() => {
    axios.get('http://localhost:5000/api/service/').then((res) => {
  ...
  return (
    <Container
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)),url('/image/Background/bg.jpg')`,
                    ...
                    >
                      ...
                      >
                        ...
                        {Service.map((type, idx) => (
                          <option
                            name="service_id"
                            value={type.service_id}
                            key={idx}
                          >
                            {type.service_name} - {type.service_price}$
                          </option>
                        ))}
                      </Form.Select>
                    </Form.Group>
