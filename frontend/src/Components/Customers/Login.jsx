...
function Login(props) {
  ...
  gapi.load('client:auth2', () => {
    window.gapi.auth2.init({
      clientId:
        '686379333298-ufinh94530414avacsme1lkr82779lp8.apps.googleusercontent.com',
      plugin_name: 'chat',
    });
  });
      ...
      <Row>
        <Col md={6}>
          ...
          <p className="px-3" style={{ color: 'hsl(218, 81%, 85%)' }}>
            PETSHOP was founded on December 25, 2022. The project was thought
            and invented by student Lam Kim Long and has an estimated completion
            time of about 4 months. During the research and development process,
            there are always some difficult problems in terms of knowledge and
            skills. But it is expected to be completed on November 31, 2023.
          </p>
        </Col>
                ...
                <Row className="g-3">
                  ...
                  <Col sm={6} md={4}>
                    <div className="text-end">
                      <span>You not account yet ?</span>
                      <Button type="submit" style={{ background: '#c98548' }}>
                        <Link
                          to="/register"
